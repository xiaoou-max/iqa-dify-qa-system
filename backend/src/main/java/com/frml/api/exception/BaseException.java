package com.frml.api.exception;

public class BaseException extends RuntimeException {
	/**
	 * 
	 */
	private static final long serialVersionUID = -7969316896159070222L;
	...
	public BaseException(int code, String message, Throwable cause, String... params) {
